...
export default function CreateTicketPage() {
  ...
  return (
    <DashboardLayout title="Create Maintenance Request" subtitle="Submit a new maintenance ticket">
        ...
        <Dialog open={showSuccess} onOpenChange={setShowSuccess}>
          <DialogContent>
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">Your maintenance request has been created successfully.</p>
            </div>
          </DialogContent>
        </Dialog>
      </div>
