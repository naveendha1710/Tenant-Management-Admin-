...
export default function TenantManage() {
  ...
  if (loading) {
    return (
      <DashboardLayout title="Manage Tenant" subtitle="Loading...">
  ...
  if (!tenant) {
    return (
      <DashboardLayout title="Manage Tenant" subtitle="Not found">
        <div className="flex justify-center p-8">Tenant not found</div>
      </DashboardLayout>
    );
  }

  return (
    <DashboardLayout title="Manage Tenant" subtitle={tenant.company_name}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setTenant({...tenant, location: e.target.value})}
                  />
                </div>
              </div>
